...
# ***********************************************************************************************************************************
# ***********************************************************************************************************************************
def insert_vectordata_nkgpt_sleeping_table(
    conn, items_id, title, description, content, url, source, document_id, embedding_str
):
    """
    ...
    """
    return insert_vectordata_sleeping_table(
        "nkgpt.insert_nkpgt_item",
        conn,
        items_id,
        title,
        description,
...
def insert_vectordata_hygiejnar_sleeping_table(
    conn, items_id, title, description, content, url, source, document_id, embedding_str
):
    """
...
def insert_vectordata_sleeping_table(
    app_procedure,
    conn,
    items_id,
    title,
